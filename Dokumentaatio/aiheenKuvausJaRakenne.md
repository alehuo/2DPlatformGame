...
Pelissä tulee olemaan yksi kenttä, joka sisältää hirviöitä ja kerättäviä kolikoita.
...
vaikuttavat loppupisteytykseen. Kun käyttäjä on suorittanut tason, peli loppuu. Sen jälkeen hänen pisteensä näytetään
